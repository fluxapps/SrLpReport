...
```php
use srag\DIC\SrLpReport\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrLpReport\x\Version\PluginVersionParameter;
...
