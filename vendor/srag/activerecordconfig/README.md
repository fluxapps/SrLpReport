# srag/activerecordconfig Library for ILIAS Plugins
...
```php
...
use srag\ActiveRecordConfig\SrLpReport\x\Config\AbstractFactory;
use srag\ActiveRecordConfig\SrLpReport\x\Config\AbstractRepository;
...
